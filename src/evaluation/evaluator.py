...
class Evaluator:
    ...
    This ensures all models (M0, M1, M2, M3) are evaluated
    using the exact same protocol.
    """
    ...
    def evaluate(self, model, X_test, y_test, model_name: str):
        ...
        Args:
            model: Model implementing BaseMLP interface
            X_test: Test data
            y_test: Test labels
            model_name: Name for storing results (e.g., 'M0', 'M1', etc.)
